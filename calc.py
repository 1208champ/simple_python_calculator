...
class MainWindow(qtw.QWidget):  # Here is where I will put my widgets.
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Calculator')  # Setting the name of the window.
        self.setLayout(qtw.QVBoxLayout())
        # btn1 = qtw.QPushButton('test')  # creating a button object
        # self.layout().addWidget(btn1)  # placing it on the window
        self.keypad()
        self.temp_nums = []
        self.fin_nums = []
        self.show()  # shows everything made in the main window class.
    ...
    def num_press(self, key_number): # Function for when a number key is clicked.
    ...
    def func_press(self, operator):  # Function for when a operator key is pressed.
        temp_string = ''.join(self.temp_nums)
    ...
    def clear_calc(self):  # Function for clearing the text field.
